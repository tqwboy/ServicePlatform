package com.hohenheim.java.serviceplatform.web.converter;
    ...
    protected void writeInternal(Object object, Type type, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        if (null != jsonConverter) {
            if (!jsonConverter.packing()) {
                ...
                BaseRespModel<Object> respModel = ResponsePack.reqFail(CoreResultCodes.REQ_OPT_FAILURE);
            ...
            if(value) {
                ...
                respData = ResponsePack.reqFail(CoreResultCodes.REQ_OPT_FAILURE);
            }
        }
        else {
            respData = ResponsePack.reqSuccess(object);
